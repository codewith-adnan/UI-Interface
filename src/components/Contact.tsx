    ...
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-sm font-medium tracking-widest text-default/50 uppercase relative inline-block after:content-[''] after:block after:w-[120px] after:h-[1px] after:bg-accent after:mx-auto after:mt-2">Contact</h2>
          <div className="text-3xl font-bold text-heading uppercase mt-2">Check Our Contact</div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3 space-y-8">
            <div className="flex items-start">
              <div className="w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center text-accent text-xl shrink-0 mr-4">
                {/* Updated Icon */}
                <BsGeoAlt />
              </div>
              <div>
